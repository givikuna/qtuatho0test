...
interface IUserServiceService_IGetProfile extends grpc.MethodDefinition<
    proto_user_pb.GetProfileRequest,
    proto_user_pb.GetProfileResponse
> {
...
export interface IUserServiceClient {
    getProfile(
        request: proto_user_pb.GetProfileRequest,
        callback: (
            error: grpc.ServiceError | null,
            response: proto_user_pb.GetProfileResponse,
        ) => void,
